...
static TAutoConsoleVariable<bool> CVarAnimNodeFootPlacementEnable(TEXT("a.AnimNode.RammsFootPlacement.Enable"), true, TEXT("Enable/Disable Foot Placement"));
static TAutoConsoleVariable<bool> CVarAnimNodeFootPlacementEnableLock(TEXT("a.AnimNode.RammsFootPlacement.Enable.Lock"), true, TEXT("Enable/Disable Foot Locking"));
static TAutoConsoleVariable<bool> CVarAnimNodeFootPlacementDebug(TEXT("a.AnimNode.RammsFootPlacement.Debug"), false, TEXT("Turn on visualization debugging for Foot Placement"));
static TAutoConsoleVariable<bool> CVarAnimNodeFootPlacementDebugTraces(TEXT("a.AnimNode.RammsFootPlacement.Debug.Traces"), false, TEXT("Turn on visualization debugging for foot ground traces"));
static TAutoConsoleVariable<int> CVarAnimNodeFootPlacementDebugDrawHistory(TEXT("a.AnimNode.RammsFootPlacement.Debug.DrawHistory"), 0,
...
{
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	/// UE::Anim::FootPlacement::FRammsFPEvalContext
	struct FRammsFPEvalContext
	{
		...
		bool GetMovementComponentIsWalkable(const FHitResult& InHit) const
		{
			if (!MovementComponent)
			{
				// RAMMS patch: no movement component (Mass crowd puppet / plain
				// skeletal actor) - accept hits up to the node's walkable slope,
				// mirroring UCharacterMovementComponent::IsWalkable.
				return InHit.IsValidBlockingHit() && InHit.ImpactNormal.Z >= WalkableFloorZ;
			}

			return MovementComponent->IsWalkable(InHit);
		}

		// RAMMS patch: cos(WalkableSlopeAngle), set at construction site.
	...
	FRammsFPEvalContext::FRammsFPEvalContext(
		FComponentSpacePoseContext& InCSPContext,
	...
	static bool FindPlantTraceImpact(
		const FRammsFPEvalContext& Context,
	...
	static bool FindPlantPlane(const FRammsFPEvalContext& Context,
		const FFootPlacementTraceSettings& TraceSettings,
		const FVector& StartPositionWS,
		const bool bCheckComplex,
...
void FAnimNode_RammsFootPlacement::FindPelvisOffsetRangeForLimb(
...
float FAnimNode_RammsFootPlacement::CalcTargetPlantPlaneDistance(
	const UE::Anim::FootPlacement::FRammsFPEvalContext& Context,
...
void FAnimNode_RammsFootPlacement::AlignPlantToGround(
	const UE::Anim::FootPlacement::FRammsFPEvalContext& Context,
...
FTransform FAnimNode_RammsFootPlacement::UpdatePlantOffsetInterpolation(
	const UE::Anim::FootPlacement::FRammsFPEvalContext& Context,
...
void FAnimNode_RammsFootPlacement::UpdatePlantingPlaneInterpolation(
	const UE::Anim::FootPlacement::FRammsFPEvalContext& Context,
...
void FAnimNode_RammsFootPlacement::DeterminePlantType(
	const UE::Anim::FootPlacement::FRammsFPEvalContext& Context,
...
float FAnimNode_RammsFootPlacement::GetMaxLimbExtension(const float DesiredExtension, const float LimbLength) const
{
...
float FAnimNode_RammsFootPlacement::GetMinLimbExtension(const float DesiredExtension, const float LimbLength) const
{
	return FMath::Min(DesiredExtension, LimbLength * PlantSettings.MinExtensionRatio);
}

void FAnimNode_RammsFootPlacement::ResetRuntimeData() 
{
...
bool FAnimNode_RammsFootPlacement::WantsToPlant(
	const UE::Anim::FootPlacement::FRammsFPEvalContext& Context,
	const UE::Anim::FootPlacement::FLegRuntimeData::FInputPoseData& LegInputPose) const
{
#if ENABLE_FOOTPLACEMENT_DEBUG
...
float FAnimNode_RammsFootPlacement::GetAlignmentAlpha(
	const UE::Anim::FootPlacement::FRammsFPEvalContext& Context,
	const UE::Anim::FootPlacement::FLegRuntimeData::FInputPoseData& LegInputPose) const
{
	return FMath::Clamp(
...
FTransform FAnimNode_RammsFootPlacement::GetFootPivotAroundBallWS(
	const UE::Anim::FootPlacement::FRammsFPEvalContext& Context,
	const UE::Anim::FootPlacement::FLegRuntimeData::FInputPoseData& LegInputPose,
...
UE::Anim::FootPlacement::FPlantResult FAnimNode_RammsFootPlacement::FinalizeFootAlignment(
	const UE::Anim::FootPlacement::FRammsFPEvalContext& Context,
...
#if ENABLE_FOOTPLACEMENT_DEBUG
void FAnimNode_RammsFootPlacement::DrawVLog(
	const UE::Anim::FootPlacement::FRammsFPEvalContext& Context,
	const UE::Anim::FootPlacement::FLegRuntimeData& LegData,
...
#if ENABLE_FOOTPLACEMENT_DEBUG
void FAnimNode_RammsFootPlacement::DrawDebug(
	const UE::Anim::FootPlacement::FRammsFPEvalContext& Context,
	const UE::Anim::FootPlacement::FLegRuntimeData& LegData,
	const UE::Anim::FootPlacement::FPlantResult& PlantResult) const
{
...
FAnimNode_RammsFootPlacement::FAnimNode_RammsFootPlacement()
{
}

// TODO: implement 
void FAnimNode_RammsFootPlacement::GatherDebugData(FNodeDebugData& NodeDebugData)
{
	ComponentPose.GatherDebugData(NodeDebugData);
}

void FAnimNode_RammsFootPlacement::Initialize_AnyThread(const FAnimationInitializeContext& Context)
{
	FAnimNode_SkeletalControlBase::Initialize_AnyThread(Context);
	ResetRuntimeData();
}

void FAnimNode_RammsFootPlacement::UpdateInternal(const FAnimationUpdateContext& Context)
{
...
void FAnimNode_RammsFootPlacement::EvaluateSkeletalControl_AnyThread(FComponentSpacePoseContext& Output,
	TArray<FBoneTransform>& OutBoneTransforms)
{
	...
	UE::Anim::FootPlacement::FRammsFPEvalContext FootPlacementContext(Output, ApproachDirCS, CachedDeltaTime);
	FootPlacementContext.WalkableFloorZ = FMath::Cos(FMath::DegreesToRadians(WalkableSlopeAngle));
...
bool FAnimNode_RammsFootPlacement::IsValidToEvaluate(const USkeleton* Skeleton, const FBoneContainer& RequiredBones)
{
#if ENABLE_FOOTPLACEMENT_DEBUG
...
void FAnimNode_RammsFootPlacement::InitializeBoneReferences(const FBoneContainer& RequiredBones)
{
	for (int32 FootIndex = 0; FootIndex < LegsData.Num(); ++FootIndex)
	{
...
void FAnimNode_RammsFootPlacement::GatherPelvisDataFromInputs(const UE::Anim::FootPlacement::FRammsFPEvalContext& Context)
{
...
void FAnimNode_RammsFootPlacement::GatherLegDataFromInputs(
	const UE::Anim::FootPlacement::FRammsFPEvalContext& Context,
	UE::Anim::FootPlacement::FLegRuntimeData& LegData,
	const FFootPlacemenLegDefinition& LegDef)
{
...
void FAnimNode_RammsFootPlacement::CalculateFootMidpoint(const UE::Anim::FootPlacement::FRammsFPEvalContext& Context, TConstArrayView<UE::Anim::FootPlacement::FLegRuntimeData> InLegsData, FVector& OutMidpoint) const
{
...
void FAnimNode_RammsFootPlacement::ProcessCharacterState(const UE::Anim::FootPlacement::FRammsFPEvalContext& Context)
{
...
void FAnimNode_RammsFootPlacement::ProcessFootAlignment(
	const UE::Anim::FootPlacement::FRammsFPEvalContext& Context,
	UE::Anim::FootPlacement::FLegRuntimeData& LegData)
{
...
FVector FAnimNode_RammsFootPlacement::GetApproachDirWS(const FAnimationBaseContext& Context) const
{
...
const FTransform& FAnimNode_RammsFootPlacement::GetRootToComponent() const
{
	return PelvisData.InputPose.RootTransformCS;
}

FTransform FAnimNode_RammsFootPlacement::SolvePelvis(const UE::Anim::FootPlacement::FRammsFPEvalContext& Context)
{
	using namespace UE::Anim::FootPlacement;
...
FTransform FAnimNode_RammsFootPlacement::UpdatePelvisInterpolationRootSpace(
	const UE::Anim::FootPlacement::FRammsFPEvalContext& Context,
